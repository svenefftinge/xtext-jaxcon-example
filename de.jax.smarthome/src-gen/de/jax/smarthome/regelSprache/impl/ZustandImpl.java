 ...
 * <ul>
 *   <li>{@link de.jax.smarthome.regelSprache.impl.ZustandImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ZustandImpl extends MinimalEObjectImpl.Container implements Zustand
{
  ...
  {
    return RegelSprachePackage.Literals.ZUSTAND;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RegelSprachePackage.ZUSTAND__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RegelSprachePackage.ZUSTAND__NAME:
        return getName();
    }
