...
public class RegelspracheSemanticSequencer extends XbaseSemanticSequencer {
	...
	/**
	 * Constraint:
	 *     (wenn=[Zustand|QualifiedName] dann=XExpression)
	 */
	protected void sequence_Regel(EObject context, Regel semanticObject) {
		...
		feeder.accept(grammarAccess.getRegelAccess().getDannXExpressionParserRuleCall_3_0(), semanticObject.getDann());
		feeder.finish();
	}
