...
:
(
{ before(grammarAccess.getRegelAccess().getDannXExpressionParserRuleCall_3_0()); }
	ruleXExpression{ after(grammarAccess.getRegelAccess().getDannXExpressionParserRuleCall_3_0()); }
)
